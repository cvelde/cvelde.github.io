...
const LIBRARY_FILE_DETECTORS = [
  {
    ...
    author: 'nicke530',
    soft: true,
    detectionReason: 'GraphicsLib shader/engine-style/texture/light config files present — mod works without it but ships will render without enhanced visuals',
  ...
  },
  {
    ...
    soft: true,
    detectionReason: 'MagicLib bounty/achievement/paintjob config files present — mod works without it but these features won\'t be available',
